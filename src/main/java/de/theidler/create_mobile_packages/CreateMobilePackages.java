...
public class CreateMobilePackages
{
    ...
    private void commonSetup(final FMLCommonSetupEvent event)
    {
        ...
        if (de.theidler.create_mobile_packages.Config.logDirtBlock)
            LOGGER.info("DIRT BLOCK >> {}", ForgeRegistries.BLOCKS.getKey(Blocks.DIRT));

        LOGGER.info(de.theidler.create_mobile_packages.Config.magicNumberIntroduction + de.theidler.create_mobile_packages.Config.magicNumber);

        de.theidler.create_mobile_packages.Config.items.forEach((item) -> LOGGER.info("ITEM >> {}", item.toString()));
    }
