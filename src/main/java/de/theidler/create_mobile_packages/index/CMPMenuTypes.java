...
public class CMPMenuTypes {
    ...
    public static final MenuEntry<DroneControllerMenu> DRONE_CONTROLLER_MENU =
            CreateMobilePackages.REGISTRATE.menu(
                    ...
                    (droneControllerMenuMenuType, containerId, playerInventory) -> new DroneControllerMenu(containerId, playerInventory, getAccurateSummary(playerInventory.player.getMainHandItem()).getStacks()),
