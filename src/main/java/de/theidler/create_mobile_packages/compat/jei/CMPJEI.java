...
public class CMPJEI implements IModPlugin {
    ...
    public void registerRecipeTransferHandlers(IRecipeTransferRegistration registration) {
        registration
                .addUniversalRecipeTransferHandler(new DroneControllerTransferHandler(registration.getJeiHelpers()));
    }

    @Override
    public void registerGuiHandlers(IGuiHandlerRegistration registration) {
        registration.addGuiContainerHandler(PortableStockTickerScreen.class,
                new CMPJEIGuiHandler(registration.getJeiHelpers().getIngredientManager()));
    }
