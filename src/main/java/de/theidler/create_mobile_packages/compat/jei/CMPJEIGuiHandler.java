...
public class CMPJEIGuiHandler implements IGuiContainerHandler<PortableStockTickerScreen> {
    ...
    @Override
    public @NotNull List<Rect2i> getGuiExtraAreas(@NotNull PortableStockTickerScreen containerScreen) {
        return containerScreen.getExtraAreas();
    }

    @Override
    public @NotNull Optional<IClickableIngredient<?>> getClickableIngredientUnderMouse(@NotNull PortableStockTickerScreen containerScreen, double mouseX, double mouseY) {
