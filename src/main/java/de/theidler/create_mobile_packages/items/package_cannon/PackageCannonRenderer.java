...
public class PackageCannonRenderer extends CustomRenderedItemModelRenderer {
    public static final IItemDecorator DECORATOR = (guiGraphics, font, stack, xOffset, yOffset) -> {
        ...
        PackageCannon.Ammo ammo = PackageCannon.getAmmo(player, stack);
        if (ammo == null || CMPItems.PACKAGE_CANNON.is(ammo.stack())) {
            return false;
        }
